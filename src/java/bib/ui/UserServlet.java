...
public class UserServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equals("deconnexion")) {
            ...
            session.invalidate();
            response.sendRedirect("http://localhost:8080/Bibliotheque1");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Utilisateur u = userEjb.logon(login, pass);
        HttpSession session = request.getSession(true);//creer la session
        if (u != null) {
            ...
            request.setAttribute("msg",
                    ...
                    + "<strong>Attention !!!</strong>  Login ou Password incorrect"
                    + "</div>");
